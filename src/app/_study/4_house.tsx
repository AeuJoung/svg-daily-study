    ...
    return(
        <section  className={styles.svgBox}>
            <svg className={styles.house} width={200} height={200} viewBox="-100 -100 200 200" >
                ...
                <polyline className={styles.roof} 
                    points="-75,-8 0,-78 75,-8" />

                <rect className={styles.door} x="-45" y="10" width="30" height="60" rx="2" />
                <circle className={styles.door_knob} cx="-35" cy="40" r="2" />
                <rect className={styles.stair} x="-47" y="70" width="34" height="5" />
                <rect className={styles.stair} x="-49" y="75" width="38" height="5" />

                <rect className={styles.window} x="5" y="15" width="40" height="35" rx="5" />
                <line x1="5" y1="32.5" x2="45" y2="32.5" />
                <line x1="25" y1="15" x2="25" y2="50" />
                <rect className={styles.window_sill} x="2" y="48" width="46" height="5" rx="5" />
